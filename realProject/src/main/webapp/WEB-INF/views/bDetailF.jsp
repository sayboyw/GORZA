...
<div id="popLine">
   ...
   <div style="width: 100%;height: 9%;" id="popProfile">
     ...
     <div>
     <span id="sub" style="position:absolute;right: 2.3%;top:4.5%;cursor: pointer;font-weight: 600;">. . .</span>
   ...
   <div style="position: relative;height: 300px;" id="midArea" >
      <span id="likeLike">
      <c:if test="${likeChk==0}">
  ...
  <a style='left:50%; font-size: 13px; color: #262626'>${boardDetail.br_date}</a>
      ...
      <p style="font-size: 14px;  color: #262626">댓글 <input style="width:30%; height: 10%" type="text"  name="reply" id="bReplyWrite" />
   ...
   function replyInsert(){//댓글 등록 기능
      ...
      $.ajax({
         ...
         success : function(data) {
            ...
            var contxt = ""
            contxt +="<tr><th style='text-align:center;'>작성자&nbsp;&nbsp;</th><th style='text-align:center;'>내용&nbsp;&nbsp;</th><th style='text-align:center;'>작성날짜&nbsp;&nbsp;</th></tr>";
